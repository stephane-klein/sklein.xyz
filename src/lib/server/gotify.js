...
const userAgentRegex = /tiny|slackbot-linkexpanding|python-requests|revoltchat|apache-httpclient|redditbot|mj12bot|semrushbot|imagesiftbot|go-http-client|whatapp|stephane-klein|applebot|exabot|yandexbot|duckduckbot|bingbot|crawl|spider|slurp|yahoo|mediapartners|facebookexternalhit|linkedinbot|twitterbot|developers\.google\.com|googlebot|adsbot-google/i;
